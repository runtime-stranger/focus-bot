...
(function () {
  ...
  function startPlayback() {
    ...
    if (!STATE.pro) {
      toast('A valid license is required to use FocusBot.', 'error');
      openUpsell();
      return;
    }
    ensureContext();
...
'<div id="fb-overlay" class="overlay" role="dialog" aria-modal="true" aria-labelledby="fb-m-title">' +
  '<div class="modal">' +
    ...
    '<p>FocusBot requires a valid annual license to operate.<br>' +
       'Purchase <strong>FocusBot Pro</strong> for unlimited binaural synthesis.</p>' +
